...
public class UpdatePlayerTest extends AbstractTest {
    ...
    public void updatePlayerIdZeroTest() throws Exception {
        mockMvc.perform(put("/rest/players/0")
    ...
    public void updatePlayerNotExistTest() throws Exception {
        mockMvc.perform(put("/rest/players/415")
                .contentType(MediaType.APPLICATION_JSON)
                .content(TestsHelper.NORMAL_JSON))
    ...
    public void updatePlayerInvalidNameTest() throws Exception {
        ...
        mockMvc.perform(MockMvcRequestBuilders.put("/rest/players/" + playerInfoTest.id)
                .contentType(MediaType.APPLICATION_JSON)
    ...
    public void updatePlayerWithIdTest() throws Exception {
        ...
        ResultActions resultActions = mockMvc.perform(put("/rest/players/5")
                .contentType(MediaType.APPLICATION_JSON)
    ...
    public void updatePlayerEmptyBodyTest() throws Exception {
        ...
        ResultActions resultActions = mockMvc.perform(put("/rest/players/17")
                .contentType(MediaType.APPLICATION_JSON)
                .content("{}"))
                .andExpect(status().isOk());
    ...
    public void updatePlayerLevelTest() throws Exception {
        ...
        ResultActions resultActions = mockMvc.perform(put("/rest/players/23")
                .contentType(MediaType.APPLICATION_JSON)
    ...
    public void updatePlayerWithDataTest1() throws Exception {
        ...
        ResultActions resultActions = mockMvc.perform(MockMvcRequestBuilders.put("/rest/players/" + playerInfoTest.id)
                .contentType(MediaType.APPLICATION_JSON)
    ...
    public void updatePlayerWithDataTest2() throws Exception {
        ...
        assertEquals("При запросе PUT /rest/players/{id} игрок должен обновляться и рейтинг пересчитываться", expected, actual);
    }
}